...
class NewDabataseWin(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.tag = customtkinter.CTkLabel(
            self, text="Defina un nombre a la base de datos:", fg_color="transparent"
        )
        self.tag.grid(row=1)
        ...
        self.user = customtkinter.CTkLabel(
            self, text="Ingrese el nombre de usuario:", fg_color="transparent"
        )
        ...
        self.pwd = customtkinter.CTkLabel(
            self, text="Ingrese una clave de acceso:", fg_color="transparent"
        )
        self.pwd.grid(row=5)

        self.npswd = customtkinter.CTkEntry(
            self, placeholder_text="Clave de Acceso", show="*"
        )
...
class RestoreDabataseWin(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.label = customtkinter.CTkLabel(
            self, text="Seleccione una base de datos a restaurar:"
        )
        self.label.grid(row=0, padx=20, pady=5)
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.restore_db_ico = customtkinter.CTkImage(
            Image.open(
                os.path.join(os.getcwd(), "assets", "arrow-counterclockwise.png")
            ),
            size=(12, 12),
        )
